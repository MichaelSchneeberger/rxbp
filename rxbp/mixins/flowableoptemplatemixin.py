...
class FlowableOpTemplateMixin(FlowableTemplateMixin, ABC):
    @abstractmethod
    def buffer(self, buffer_size: int = None) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def concat(self, *sources: FlowableTemplateMixin) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def first(self, raise_exception: Callable[[Callable[[], None]], None]) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def flat_map(self, func: Callable[[Any], FlowableTemplateMixin]) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def map(self, func: Callable[[Any], Any]) -> FlowableTemplateMixin:
    ...
    @abstractmethod
    def merge(self, *others: FlowableTemplateMixin) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def observe_on(self, scheduler: Scheduler) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def pairwise(self) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def repeat_first(self) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def scan(self, func: Callable[[Any, Any], Any], initial: Any) -> FlowableTemplateMixin:
        """
    ...
    def share(self) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def to_list(self) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def zip(self, *others: FlowableTemplateMixin) -> FlowableTemplateMixin:
        """
    ...
    @abstractmethod
    def zip_with_index(self) -> FlowableTemplateMixin:
        """
