...
class Observer[V](ABC):
    ...
    # def on_next_and_complete(self, value: V) -> ContinuationCertificate | ContinuationMonad[ContinuationCertificate]: ...

    @abstractmethod
    def on_completed(self) -> ContinuationMonad[ContinuationCertificate]: ...
    # def on_completed(self) -> ContinuationCertificate | ContinuationMonad[ContinuationCertificate]: ...

    @abstractmethod
    def on_error(self, exception: Exception) -> ContinuationMonad[ContinuationCertificate]: ...
    # def on_error(self, exception: Exception) -> ContinuationCertificate | ContinuationMonad[ContinuationCertificate]: ...
