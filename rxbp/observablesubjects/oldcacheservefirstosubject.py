...
class CacheServeFirstOSubject(OSubjectBase):
    ...
    and buffers the last elements according to the slowest inner subscriber.
    """
    ...
    def __init__(self, scheduler: Scheduler, name=None):
        ...
        # indicates that the stream is completed
        self.is_done = False
    ...
    def observe(self, observer_info: ObserverInfo):
        ...
        with self.lock:
            ...
            # todo: needs that to be in the lock?
