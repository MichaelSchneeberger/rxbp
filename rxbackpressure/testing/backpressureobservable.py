...
class BackpressureObservable(BackpressureObservable):
    ...
    def subscribe(self, on_next=None, on_error=None, on_completed=None, observer=None, subscribe_bp=None):
        ...
        return self._subscribe_core(observer, subscribe_bp=subscribe_bp)

    def _subscribe_core(self, observer, subscribe_bp):
        observable = self
