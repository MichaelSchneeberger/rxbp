...
from rxbp.indexed.selectors import BaseAndSelectors, BaseSelectorsAndSelectorMaps
...
from rxbp.indexed.selectors import IdentitySelectorMap, ObservableSelectorMap
from rxbp.subscriber import Subscriber
from rxbp.testing.testobservable import TestObservable
from rxbp.testing.testscheduler import TestScheduler
from tests.test_indexed.test_selectors.testbase import TestBase
...
class TestBaseSelectorTuple(unittest.TestCase):
    ...
    def test_match_two_bases_by_identity(self):
        ...
        result: Optional[BaseSelectorsAndSelectorMaps] = t1.match_with(t2, self.subscriber)
