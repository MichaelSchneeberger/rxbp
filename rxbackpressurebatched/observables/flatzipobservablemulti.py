...
class FlatZipObservableMulti(Observable):
    """
        ...
        def on_next_left(left_elem):
            ...
            def gen_child_observers():
                for idx, val in enumerate(left_vals):
                    ...
                    if 0 < idx:
                        connectable_observer = ConnectableSubscriber(underlying=child_observer, scheduler=immediate_scheduler)
